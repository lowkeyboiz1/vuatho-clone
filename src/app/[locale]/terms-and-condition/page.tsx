  ...
  return (
    <div className='flex flex-col gap-6'>
      <div className='flex flex-col gap-6'>
        ...
        <p className='text-[1.6rem]'>{t('text5')}</p>
        <p className='text-[1.6rem]'>{t('text6')}</p>
      </div>
      <div className='flex flex-col gap-6'>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <p className='text-[1.6rem] underline'>{t('text19')}</p>
        <p className='text-[1.6rem]'>{t('text20')}</p>
        ...
        <p className='text-[1.6rem] underline'>{t('text27')}</p>
        <p className='text-[1.6rem]'>{t('text28')}</p>
        <ul className='list-inside list-disc text-[1.6rem]'>
          <li>{t('text29')}</li>
          <li>{t('text30')}</li>
          <li>{t('text31')}</li>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <p className='text-[1.6rem]'>{t('text46')}</p>
        <p className='text-[1.6rem]'>{t('text47')}</p>
        <h5 className='text-[1.6rem] text-[#0B27B6]/90'>{t('text48')}</h5>
        <p className='text-[1.6rem]'>{t('text49')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text50')}</h4>
        <h5 className='text-[1.6rem] text-[#0B27B6]/90'>{t('text51')}</h5>
        <p className='text-[1.6rem]'>{t('text52')}</p>
        <p className='text-[1.6rem]'>{t('text53')}</p>
        <p className='text-[1.6rem]'>{t('text54')}</p>
        <h5 className='text-[1.6rem] text-[#0B27B6]/90'>{t('text55')}</h5>
        <p className='text-[1.6rem]'>{t('text56')}</p>
        <h5 className='text-[1.6rem] text-[#0B27B6]/90'>{t('text57')}</h5>
        <p className='text-[1.6rem]'>{t('text58')}</p>
        <ul className='list-inside list-disc text-[1.6rem]'>
          <li>
            {t('text59')}
            <br />
        ...
        <p className='text-[1.6rem]'>{t('text64')}</p>
        <p className='text-[1.6rem]'>{t('text65')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text66')}</h4>
        <p className='text-[1.6rem]'>{t('text67')}</p>
        <p className='text-[1.6rem]'>{t('text68')}</p>
        <ul className='list-inside list-disc text-[1.6rem]'>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <h5 className='text-[1.6rem] text-[#0B27B6]/90'>{t('text75')}</h5>
        <p className='text-[1.6rem]'>{t('text76')}</p>
        <p className='text-[1.6rem]'>{t('text77')}</p>
        <p className='text-[1.6rem]'>{t('text78')}</p>
        ...
        <h5 className='text-[1.6rem] text-[#0B27B6]/90'>{t('text85')}</h5>
        <p className='text-[1.6rem]'>{t('text86')}</p>
        <p className='text-[1.6rem]'>{t('text87')}</p>
        <p className='text-[1.6rem]'>{t('text88')}</p>
        <p className='text-[1.6rem]'>{t('text89')}</p>
        <p className='text-[1.6rem]'>{t('text90')}</p>
        <p className='text-[1.6rem]'>{t('text91')}</p>
      </div>
      <div className='flex flex-col gap-6'>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <p className='text-[1.6rem]'>{t('text104')}</p>
        <ul className='list-inside list-disc text-[1.6rem]'>
          <li>{t('text105')}</li>
          <li>{t('text106')}</li>
          <li>{t('text107')}</li>
        ...
        <p className='text-[1.6rem]'>{t('text109')}</p>
        <p className='text-[1.6rem]'>{t('text110')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text111')}</h4>
        <p className='text-[1.6rem]'>{t('text112')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text113')}</h4>
        <p className='text-[1.6rem]'>{t('text114')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text115')}</h4>
        <p className='text-[1.6rem]'>{t('text116')}</p>
        <p className='text-[1.6rem]'>{t('text117')}</p>
        <p className='text-[1.6rem]'>{t('text118')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text119')}</h4>
        <p className='text-[1.6rem]'>{t('text120')}</p>
        <p className='text-[1.6rem]'>{t('text121')}</p>
      </div>
      <div className='flex flex-col gap-6'>
        <h4 className='text-[1.8rem] font-bold text-[#0B27B6]'>{t('text122')}</h4>
        <p className='text-[1.6rem]'>{t('text123')}</p>
