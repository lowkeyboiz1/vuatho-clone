          ...
          <div className='flex flex-col gap-2'>
            {listAccordion.map((i: any, index: number) => (
              <button
                ...
                className={`flex w-full items-center justify-start rounded-[60px] px-10 py-6 text-[1.6rem] ${
...
const Step1: React.FC = () => {
  ...
  return (
    <>
      <h3 className='text-[1.6rem] font-bold text-[#0B27B6]'>{t('text13')}</h3>
      <ul className='mt-4 list-inside list-disc'>
        {DocRequirements.map((item) => (
          <li key={item} className='text-[1.6rem] text-[#555]'>
            {item}
          </li>
        ))}
      </ul>
      <h4 className='mt-14 text-[1.6rem] font-medium'>{t('text14')}</h4>
      <ul className='mt-4 list-inside list-disc'>
        {DocType.map((item) => (
          <li key={item} className='text-[1.6rem] text-[#555]'>
            {item}
...
const Step2: React.FC = () => {
  ...
  return (
    <>
      <h3 className='text-[1.6rem] font-bold text-[#0B27B6]'>{t('text15')}</h3>
      <div className='flex flex-col items-start gap-10 md:gap-20 lg:flex-row lg:gap-40'>
        <div className='flex items-center gap-10'>
          <div className='mt-8 space-y-10'>
            <div>
              <h4 className='mb-2 text-[1.6rem]'> {t('text16')}</h4>
              <AndroidBtn />
            </div>
            <div>
              <h4 className='mb-2 text-[1.6rem]'> {t('text17')}</h4>
              <IosBtn />
            </div>
          </div>
          <span className='text-[1.6rem] text-black/50'> {t('text18')}</span>
          <QrCode />
        </div>
      </div>
    </>
...
const Step3: React.FC = () => {
  ...
  return (
    <>
      <h3 className='text-[1.6rem] font-bold text-[#0B27B6]'>{t('text19')}</h3>
      <h4 className='mt-8 text-[1.6rem] font-bold'> {t('text20')}</h4>
      <p className='mt-5 text-[1.6rem]'>{t('text21')}</p>
        ...
        <div className=' mt-5 w-full space-y-5'>
          ...
          <div className='flex justify-start'>
            <div className='relative mr-20 flex w-full flex-col justify-center rounded-2xl bg-primary-blue/10 p-8  3xl:mr-28'>
              <div className='flex justify-end'>
                <p className='w-[60%] text-right text-[1.6rem]'>
      ...
      <h4 className='mt-8 text-[1.6rem] font-bold'>{t('text31')}</h4>
      <p className='text-[1.6rem]'>{t('text32')}</p>
      <p className='text-[1.6rem]'>{t('text33')}</p>
      ...
      <h4 className='mt-8 text-[1.6rem] font-bold'>{t('text34')}</h4>
      <p className='text-[1.6rem]'>{t('text35')}</p>
      ...
      <Image
        ...
        className='my-8'
      />
      <strong className='text-[1.6rem]'>{t('text37')}</strong>
      <p className='text-[1.6rem]'>{t('text38')}</p>
      <p className='mb-8 text-[1.6rem]'>{t('text39')}</p>
      ...
      <p className='my-8'>
        <strong className='text-[1.6rem]'>{t('text40')}</strong>
      </p>
      <Image
...
const Step4: React.FC = () => {
  ...
  return (
    <>
      <h3 className='text-[1.6rem] font-bold text-[#0B27B6]'>{t('text41')}</h3>
      <p className='mt-8 text-[1.6rem]'>{t('text42')}</p>
      <p className='mt-5 text-[1.6rem]'>{t('text43')}</p>
      <div className='mt-5 flex justify-center'>
        <div className='relative w-fit rounded-xl border-2 border-base-gray p-4'>
          <p className='absolute -left-1 top-3 rounded-r-full bg-base-gray p-5 pr-10 text-center text-[1.6rem] font-medium shadow-md '>
            {t('text44')}
          </p>
          <Image
            alt='noti-kyc'
      ...
      <div className='mt-5 flex justify-center'>
        <div className='relative w-fit rounded-xl border-2 border-base-gray p-4 pt-32'>
          ...
          <Image
            ...
            className='h-auto w-[350px] object-contain 2xl:w-[450px] '
          />
          <p className='mt-2 text-center text-[1.6rem] text-black/30'>
            {t('text46')}
            <br />
            {t('text47')}
          </p>
      ...
      <p className='mt-8 text-[1.6rem]'>{t('text48')}</p>
...
const Step5: React.FC = () => {
  ...
  return (
    <>
      <h3 className='text-[1.6rem] font-bold text-[#0B27B6]'>{t('text50')}</h3>
      <p className='mt-8 text-[1.6rem]'>{t('text51')}</p>
      <div className='mt-8 flex w-fit flex-col items-center gap-10 rounded-xl bg-black/[0.02] p-8 md:flex-row'>
        ...
        />
        <p className='text-center text-[1.6rem] md:w-[400px] md:text-left'>
          {t('text50')}
        </p>
      </div>
      <p className='mt-8 text-[1.6rem]'>{t('text52')}</p>
      <div className='mt-8 flex flex-col items-center gap-10 xl:flex-row'>
        <div className='flex w-[300px] flex-col items-center space-y-6 lg:w-[350px] xl:w-[300px] 2xl:w-[400px]'>
          ...
          />
          <p className='text-center text-[1.6rem] text-black/30'>{t('text53')}</p>
        </div>
        <span className='text-[1.6rem] text-black/50'>{t('or')}</span>
        <div className='flex w-[300px] flex-col items-center space-y-6 lg:w-[350px] xl:w-[300px] 2xl:w-[400px]'>
          <Image
            alt='noti-kyc'
            ...
            className='h-auto w-[300px] object-contain 2xl:w-[400px]'
          />
          <p className='text-center text-[1.6rem] text-black/30'>{t('text54')}</p>
        </div>
      </div>
    </>
  )
