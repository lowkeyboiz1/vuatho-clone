...
function SectionToTheMoon() {
  ...
  return (
    <div className='flex-center ct-container-70 gap-[60px] w-full mt-10 flex-col md:flex-row'>
      ...
      <div className='w-full mt-2 order-1 md:order-3'>
        <h3 className='text-[4.6rem] md:text-[6rem] w-full text-center 13inch:text-[5rem] 3xl:text-[4rem] font-semibold md:hidden block'>
