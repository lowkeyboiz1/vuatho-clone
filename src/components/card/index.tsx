    ...
    <div className='h-full w-full group relative rounded-[60px] overflow-hidden px-8 xl:px-20 bg-black/[0.02]'>
      ...
      <div className=''>
        <Image
          ...
          width={384}
          height={478}
          className='absolute bottom-[5%] left-[3%] z-[1] max-h-[478px] md:h-[75%] h-[70%] w-auto object-contain'
        />
        {/* 2xl:h-[478px] 13inch:h-[400px] w-auto object-contain */}
      </div>
      <div className='absolute -bottom-[4%] -left-[2%] bg-primary-blue/50 h-1/2 aspect-square w-fit rounded-full blur-2xl' />
      <div className='absolute -top-[4%] -right-[2%] bg-primary-blue/10 h-1/2 aspect-square w-fit rounded-full blur-2xl' />
      <div className='absolute -top-[4%] -left-[2%] bg-primary-yellow/10 h-1/3 aspect-square w-fit rounded-full blur-2xl' />
      <div className='absolute bottom-[4%] -right-[2%] bg-primary-yellow/10 h-1/2 aspect-square w-fit rounded-full blur-2xl' />
    </div>
  )
}
    ...
    <div className='h-full w-full group relative rounded-[60px] overflow-hidden px-8 xl:px-20 bg-black/[0.02]'>
      ...
      <div className=''>
        <Image
          ...
          width={384}
          height={478}
          className='absolute bottom-[5%] right-[3%] z-[1] scale-x-[-1] max-h-[478px] md:h-[75%] h-[70%] w-auto object-contain'
        />
      </div>
      <div className='absolute -bottom-[4%] -right-[2%] bg-primary-blue/50 h-1/2 aspect-square w-fit rounded-full blur-2xl' />
      <div className='absolute -top-[4%] -left-[2%] bg-primary-blue/10 h-1/2 aspect-square w-fit rounded-full blur-2xl' />
      <div className='absolute -top-[4%] -right-[2%] bg-primary-yellow/10 h-1/3 aspect-square w-fit rounded-full blur-2xl' />
      <div className='absolute bottom-[4%] -left-[2%] bg-primary-yellow/10 h-1/2 aspect-square w-fit rounded-full blur-2xl' />
    </div>
  )
}
